...
class AntiTermiteScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.length_input = styled_input('Surface Length (m)')
        self.width_input = styled_input('Surface Width (m)')
        self.coverage_input = styled_input('Coverage per Liter (m²)')
        self.price_input = styled_input('Cost per Liter (₹)')

        content.add_widget(self.length_input)
        content.add_widget(self.width_input)
        content.add_widget(self.coverage_input)
